...
new class extends Component {
    public array $headerImages = [
        '/img/kegiatan/paska/IMG-20250426-WA0055.jpg',
        '/img/kegiatan/paska/IMG-20250428-WA0021.jpg',
        '/img/kegiatan/paska/IMG-20250428-WA0273.jpg',
    ];

    public array $programs = [
        [
            'title' => 'Ibadah',
            'desc' => 'Pelaksanaan ibadah Paskah yang khusyuk untuk mengenang pengorbanan Yesus Kristus di kayu salib dan merayakan kebangkitan-Nya yang memberikan pengharapan bagi setiap orang percaya.',
            'image' => '/img/kegiatan/paska/IMG-20250428-WA0201.jpg',
        ],
        [
            'title' => 'Drama & Pujian',
            'desc' => 'Penampilan drama yang menggambarkan kisah Paskah serta persembahan pujian dan penyembahan yang meriah untuk memuliakan nama Tuhan dalam suasana penuh sukacita.',
            'image' => '/img/kegiatan/paska/IMG-20250428-WA0207.jpg',
        ],
        [
            'title' => 'Kebersamaan',
            'desc' => 'Momentum istimewa untuk mempererat kebersamaan, iman, dan kasih antar sesama mahasiswa PMK dalam semangat persaudaraan Kristiani yang hangat dan penuh makna.',
            'image' => '/img/kegiatan/paska/IMG-20250428-WA0273.jpg',
        ],
    ];
        ...
        <div class="relative z-10 flex h-full items-center">
            <div class="mx-auto max-w-7xl px-6 text-white w-full">
                <h1 class="text-5xl font-bold sm:text-7xl">
                    Perayaan <span class="bg-clip-text text-transparent bg-gradient-to-br from-[#fbbf24] to-[#f97316]">Paskah</span>
                </h1>
    ...
    <section class="w-full bg-white py-20 overflow-hidden">
        <div class="mx-auto max-w-6xl px-6 reveal-on-scroll opacity-0">
            <h2 class="text-3xl font-bold text-gray-900">
                Tentang <span class="text-gray-900">Paskah</span>
            </h2>
            ...
            <div class="mt-6 text-lg leading-relaxed text-gray-700">
                <span class="block text-2xl font-bold leading-snug text-gray-900 sm:text-3xl">
                    Kegiatan Paskah merupakan momentum istimewa yang dirayakan oleh
                    PMK Universitas Dipa Makassar untuk mengenang pengorbanan dan
                    kebangkitan Yesus Kristus
                </span>

                <span class="mt-5 block text-lg sm:text-xl">
                    Acara ini melibatkan <strong>ibadah</strong>,
                    <strong> drama</strong>, <strong>pujian</strong>, dan 
                    <strong> kebersamaan</strong> yang mempererat iman dan kasih antar
                    sesama mahasiswa.
                </span>
            </div>
        </div>
