...
<section
    ...
    x-intersect.once="isInView = true"
    class="bg-[#0f1116] py-24 lg:py-32 min-h-screen"
>
    <div class="max-w-7xl mx-auto grid lg:grid-cols-12 gap-x-16 items-center px-4 md:px-6 lg:px-8">

        {{-- FOTO + STATISTIK --}}
        <div
            class="lg:col-span-6 flex flex-col items-center text-center lg:text-left transition-all duration-1000 transform"
        ...
        {{-- VISI MISI --}}
        <div
            class="lg:col-span-6 mt-12 lg:mt-0 transition-all duration-1000 delay-300 transform"
            :class="isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'"
        >
            <h2 class="text-base text-indigo-400 uppercase tracking-wide font-semibold">BAB IV</h2>
