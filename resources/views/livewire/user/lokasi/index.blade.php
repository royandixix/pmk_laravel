...
<div class="min-h-screen bg-slate-50 font-sans">
    <div class="text-center py-20 px-6">
        <span class="inline-block mb-4 rounded-full bg-indigo-100 px-4 py-1 text-xs font-semibold tracking-widest text-indigo-700 uppercase">
            SEKRETARIAT PMK
        </span>

        <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 leading-tight">
            Sekretariat PMK <br class="hidden lg:block" />
        ...
        <div class="flex flex-col lg:flex-row gap-14 items-center">
            ...
            <div class="w-full lg:w-1/2">
                ...
                <p class="text-slate-600 leading-relaxed mb-8">
                    Sekretariat PMK menjadi pusat koordinasi dan pembinaan rohani
                    mahasiswa. Suasana dibuat nyaman dan fungsional untuk mendukung
                    diskusi, pelayanan, serta pengembangan kepemimpinan.
                </p>
    ...
    <section class="relative w-full h-[760px]">
        <iframe
            ...
            loading="lazy"
            title="Maps"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.81234!2d119.51234!3d-5.12345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMDcnNDQuNCJTIDExOcKwMzAnNDQuNCJF!5e0!3m2!1sen!2sid!4v123456789"
        ></iframe>
