    ...
    public function mount()
    {
        $this->partners = [
            [
                'id' => 1,
                'name' => "CHINDY LINDANG",
                'description' => "Koordinator Bidang Kesekretariatan dan Dana yang bertanggung jawab atas administrasi dan keuangan.",
                'image' => "/img/pengurus/kesda/CHINDY LINDANG(KORD).jpg",
                'category' => "Koordinator",
            ],
            [
                'id' => 2,
                'name' => "ALFREIN CHRISTIANO SIRANGA",
                'description' => "Staff Kesekretariatan yang mengelola arsip dan dokumen organisasi.",
                'image' => "/img/pengurus/kesda/ALFREIN CHRISTIANO SIRANGA.jpg",
                'category' => "Staff",
            ],
            [
                'id' => 3,
                'name' => "HARIYANTO PANGLI BARA",
                'description' => "Staff Dana yang berfokus pada penggalangan dana kreatif organisasi.",
                'image' => "/img/pengurus/kesda/HARIYANTO PANGLI BARA.jpg",
                'category' => "Staff",
            ],
            [
                'id' => 4,
                'name' => "NUR SURYANI ROMAN",
                'description' => "Staff Administrasi yang membantu ketertiban inventaris dan surat-menyurat.",
                'image' => "/img/pengurus/kesda/NUR SURYANI ROMAN.JPG",
                'category' => "Staff",
            ],
            [
                'id' => 5,
                'name' => "TRI PUTRA APPANGALLO",
                'description' => "Staff Administrasi yang mendukung kelancaran operasional kesekretariatan.",
                'image' => "/img/pengurus/kesda/TRI PUTRA APPANGALLO.JPG",
                'category' => "Staff",
            ],
        ];
    }
...
<div x-data="{ selected: null }" 
     ...
     "
     class="relative min-h-screen bg-[#09090b]">

    <div class="relative h-[40vh] md:h-[50vh] w-full bg-cover bg-center bg-fixed" 
         style="background-image: url('{{ asset('/img/pengurus/kesda/kesda-min.JPG') }}')">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div class="max-w-3xl text-white animate-fade-in">
                <h1 class="text-3xl md:text-5xl font-bold mb-4 tracking-tight uppercase leading-tight">
                    Bidang <br class="hidden md:block"/> Kesekretariatan & Dana
                </h1>
                <p class="text-sm md:text-lg text-gray-300 leading-relaxed max-w-xl font-light">
                    Mengelola administrasi, inventaris, dan keuangan organisasi secara profesional demi kelancaran program kerja.
                </p>
            </div>
        </div>
    </div>
    ...
    <template x-teleport="body">
        <div x-show="selected" 
            ...
            <div @click.away="selected = null" 
                 ...
                 class="relative max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-zinc-950 rounded-3xl border border-white/10 shadow-2xl flex flex-col md:flex-row">
                
                <button @click="selected = null" 
                        class="absolute top-4 right-4 z-50 bg-black/50 rounded-full text-white/70 hover:text-white p-2 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                </button>

                <div class="w-full md:w-[45%] shrink-0 aspect-[4/5] md:aspect-auto bg-zinc-900">
                ...
                <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-zinc-950">
                    ...
                    <div class="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                        <span class="text-[8px] text-zinc-600 uppercase tracking-[0.2em]">Bidang Kesda</span>
