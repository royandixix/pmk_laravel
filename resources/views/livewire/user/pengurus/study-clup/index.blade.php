    ...
    public function mount()
    {
        $this->partners = [
            [
                'id' => 1,
                'name' => 'CARMELITHA',
                'description' => 'Koordinator Bidang Study Club yang bertanggung jawab atas pengembangan akademik dan wawasan keilmuan anggota.',
                'image' => '/img/pengurus/study_clup/CARMELITHA (KORD).jpg',
                'category' => 'Koordinator',
            ],
            [
                'id' => 2,
                'name' => 'GEIBEL PAGAYANG SARONGALLO',
                'description' => 'Staff bidang yang berkontribusi dalam memfasilitasi diskusi dan pembelajaran rutin.',
                'image' => '/img/pengurus/study_clup/GEIBEL PAGAYANG SARONGALLO.jpg',
                'category' => 'Staff',
            ],
            [
                'id' => 3,
                'name' => 'MARSUKI',
                'description' => 'Staff bidang yang membantu pengelolaan materi dan sumber belajar bagi anggota.',
                'image' => '/img/pengurus/study_clup/MARSUKI.jpg',
                'category' => 'Staff',
            ],
            [
                'id' => 4,
                'name' => 'MICHELLE EVANGELINE SERU',
                'description' => 'Staff bidang yang berperan dalam mengoordinasi jadwal dan teknis pelaksanaan study club.',
                'image' => '/img/pengurus/study_clup/MICHELLE EVANGELINE SERU.jpg',
                'category' => 'Staff',
            ],
        ];
    }
...
<div x-data="{ selected: null }" class="relative min-h-screen bg-[#09090b]">
    ...
    <div class="relative h-[40vh] md:h-[50vh] w-full bg-cover bg-center bg-fixed" 
         style="background-image: url('{{ asset('/img/pengurus/study_clup/Study Club-min.jpg') }}')">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div class="max-w-3xl text-white animate-fade-in">
                <h1 class="text-3xl md:text-5xl font-bold mb-4 tracking-tight uppercase leading-tight">
                    Bidang <br class="hidden md:block"/> Study Club
                </h1>
                <p class="text-sm md:text-lg text-gray-300 leading-relaxed max-w-xl font-light">
                    Berfokus pada pengembangan akademik dan wawasan keilmuan anggota melalui diskusi dan pembelajaran rutin yang inovatif.
                </p>
            </div>
        </div>
    </div>
    ...
    {{-- Modal Detail - Optimized for Mobile --}}
    <template x-teleport="body">
        <div x-show="selected" 
            ...
            <div @click.away="selected = null" 
                ...
                {{-- Close Button - Dibuat Jelas & Mudah Klik --}}
                ...
                <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-zinc-950">
                    ...
                    <div class="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                        <span class="text-[8px] text-zinc-600 uppercase tracking-[0.2em]">Bidang Study Club</span>
