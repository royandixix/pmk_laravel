...
new class extends Component {
    ...
    public function mount()
    {
        $this->partners = [
            ...
            [
                'id' => 2,
                'name' => "ANGEL CHINTYA TIMANG",
                'description' => "Staff bidang yang aktif mendukung pelaksanaan kegiatan pengembangan minat bakat anggota.",
                'image' => "/img/pengurus/mb/ANGEL CHINTYA TIMANG.jpg",
                'category' => "Staff",
            ],
            [
                'id' => 3,
                'name' => "ARY ANGGARA LOLOPAYUNG",
                'description' => "Staff bidang yang berfokus pada koordinasi kegiatan kreativitas dan kebersamaan.",
                'image' => "/img/pengurus/mb/ARY ANGGARA LOLOPAYUNG.jpg",
                'category' => "Staff",
            ],
            [
                'id' => 4,
                'name' => "EXCEL RANCY KRISTIAN KALA'LINGGI",
                'description' => "Staff bidang yang mendukung kelancaran setiap program kerja minat dan bakat.",
                'image' => "/img/pengurus/mb/EXCEL RANCY KRISTIAN KALA'LINGGI.jpg",
                'category' => "Staff",
            ],
        ];
    }
...
<div x-data="{ selected: null }" 
    ...
    <div class="relative h-[40vh] md:h-[50vh] w-full bg-cover bg-center bg-fixed" 
         style="background-image: url('{{ asset('/img/pengurus/mb/mb-min.JPG') }}')">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div class="max-w-3xl text-white animate-fade-in">
                <h1 class="text-3xl md:text-5xl font-bold mb-4 tracking-tight uppercase leading-tight">
                    Bidang Minat <br class="hidden md:block"/> dan Bakat
                </h1>
                <p class="text-sm md:text-lg text-gray-300 leading-relaxed max-w-xl font-light">
                    Mewadahi pengembangan potensi anggota dalam bidang seni, olahraga, dan kreativitas untuk membangun kepercayaan diri.
                </p>
            </div>
        </div>
    </div>
            ...
            <div @click.away="selected = null" 
                ...
                <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-zinc-950">
                    ...
                    <div class="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                        <span class="text-[8px] text-zinc-600 uppercase tracking-[0.2em]">Bidang Minat Bakat</span>
