...
new class extends Component {
    ...
    public function mount()
    {
        $this->partners = [
            ...
            [
                'id' => 3,
                'name' => 'JEVALIN MUTIA KASIH',
                'description' => 'Staff yang berfokus pada koordinasi pelayanan doa dan persekutuan rutin antar anggota PMK.',
                'image' => '/img/pengurus/kerohanian/JEVALIN MUTIA KASIH.jpg',
                'category' => 'Staff',
            ],
            [
                'id' => 4,
                'name' => 'MARCHELLA EKA PUTRI IRAWATI',
                'description' => 'Staff yang mengelola kebutuhan dokumentasi dan persiapan materi peribadatan dalam setiap persekutuan.',
                'image' => '/img/pengurus/kerohanian/MARCHELLA EKA PUTRI IRAWATI.JPG',
                'category' => 'Staff',
            ],
            [
                'id' => 5,
                'name' => 'NI KADEK VIONA',
                'description' => 'Staff yang membantu kelancaran operasional pelayanan dan komunikasi internal tim kerohanian.',
                'image' => '/img/pengurus/kerohanian/NI KADEK VIONA.JPG',
                'category' => 'Staff',
            ],
        ];
    }
...
<div x-data="{ selected: null }" class="relative min-h-screen bg-[#09090b]">
    ...
    <div class="relative h-[40vh] md:h-[50vh] w-full bg-cover bg-center bg-fixed" 
         style="background-image: url('{{ asset('/img/pengurus/kerohanian/kerohanian-min.JPG') }}')">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div class="max-w-3xl text-white animate-fade-in">
                <h1 class="text-3xl md:text-5xl font-bold mb-4 tracking-tight uppercase leading-tight">
                    Bidang Kerohanian <br class="hidden md:block"/> dan Pelayanan
                </h1>
                <p class="text-sm md:text-lg text-gray-300 leading-relaxed max-w-xl font-light">
                    Bertanggung jawab atas pertumbuhan iman dan seluruh kegiatan rohani di PMK Universitas Dipa Makassar.
                </p>
            </div>
        </div>
    </div>
    ...
    <template x-teleport="body">
        <div x-show="selected" 
             ...
             class="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-5"
            ...
            <div @click.away="selected = null" 
                 ...
                 class="relative max-w-2xl w-full bg-zinc-950 rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col md:flex-row">
                
                {{-- Close Button --}}
                <button @click="selected = null" 
                        class="absolute top-4 right-4 z-50 text-white/50 hover:text-white p-2 transition-all">
                ...
                {{-- Left: Image --}}
                <div class="w-full md:w-[45%] aspect-square md:aspect-auto bg-zinc-900">
                ...
                <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-zinc-950">
                    <span class="text-blue-500 font-bold tracking-[0.2em] text-[9px] uppercase mb-2 block" x-text="selected?.category"></span>
                    ...
                    <div class="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                        <span class="text-[8px] text-zinc-600 uppercase tracking-[0.2em]">Bidang Kerohanian</span>
