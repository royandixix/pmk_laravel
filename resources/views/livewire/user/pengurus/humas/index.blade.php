...
new class extends Component {
    ...
    public function mount()
    {
        $this->partners = [
            ...
            [
                'id' => 2,
                'name' => "ELVIN KURNIATY MA'DIKA",
                'description' => 'Staff bidang yang berperan aktif dalam menjalin komunikasi internal anggota PMK.',
                'image' => "/img/pengurus/humas/ELVIN KURNIATY MA'DIKA.JPG",
                'category' => 'Staff',
            ],
            [
                'id' => 3,
                'name' => 'GLEN',
                'description' => 'Staff bidang yang membantu pengelolaan informasi dan publikasi kegiatan organisasi.',
                'image' => '/img/pengurus/humas/GLEN.JPG',
                'category' => 'Staff',
            ],
            [
                'id' => 4,
                'name' => 'MELISA MAMBELA',
                'description' => 'Staff bidang yang berfokus pada koordinasi hubungan eksternal dan kerja sama.',
                'image' => '/img/pengurus/humas/MELISA MAMBELA.JPG',
                'category' => 'Staff',
            ],
            [
                'id' => 5,
                'name' => 'TEGUH ARJUNA',
                'description' => 'Staff bidang yang mendukung kelancaran arus informasi antar divisi di PMK.',
                'image' => '/img/pengurus/humas/TEGUH ARJUNA.JPG',
                'category' => 'Staff',
            ],
        ];
    }
...
<div x-data="{ selected: null }" class="relative min-h-screen bg-[#09090b]">
    ...
    <div class="relative h-[40vh] md:h-[50vh] w-full bg-cover bg-center bg-fixed" 
         style="background-image: url('{{ asset('/img/pengurus/humas/humas-min.JPG') }}')">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div class="max-w-3xl text-white animate-fade-in">
                <h1 class="text-3xl md:text-5xl font-bold mb-4 tracking-tight uppercase leading-tight">
                    Bidang <br class="hidden md:block"/> Humas
                </h1>
                <p class="text-sm md:text-lg text-gray-300 leading-relaxed max-w-xl font-light">
                    Bidang Hubungan Masyarakat bertanggung jawab dalam menjalin, menjaga, dan mengembangkan komunikasi internal dan eksternal.
                </p>
            </div>
        </div>
    </div>
    ...
    <template x-teleport="body">
        <div x-show="selected" 
             ...
             class="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 backdrop-blur-sm p-4 md:p-5"
            ...
            <div @click.away="selected = null" 
                 ...
                 class="relative max-w-2xl w-full bg-zinc-950 rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col md:flex-row max-h-[90vh] md:max-h-none overflow-y-auto md:overflow-visible">
                ...
                <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-zinc-950">
                    ...
                    <div class="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                        <span class="text-[8px] text-zinc-600 uppercase tracking-[0.2em]">Bidang Humas</span>
